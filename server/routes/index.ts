...
export const apiRoutes = {
  packages: {
    base: '/api/packages',
    endpoints: [
      { method: 'GET', path: '/', description: 'Get all packages' },
      { method: 'GET', path: '/:id', description: 'Get package by ID' },
      { method: 'POST', path: '/', description: 'Create new package' },
      { method: 'PUT', path: '/:id', description: 'Update package' },
      { method: 'DELETE', path: '/:id', description: 'Delete package' },
    ]
  },
  payments: {
    base: '/api/payments',
    endpoints: [
      ...
      { method: 'GET', path: '/packages/:packageId/payment', description: 'Get payment by package ID' },
      { method: 'POST', path: '/', description: 'Create new payment' },
      { method: 'PUT', path: '/:id', description: 'Update payment' },
      { method: 'DELETE', path: '/:id', description: 'Delete payment' },
    ]
  }
};
...
export const paymentRoutes = {
  ...
  getByPackageId: async (req: any, res: any) => {
    try {
...
export function registerRoutes(app: Express) {
  // Package routes
  app.get(apiRoutes.packages.base, packageRoutes.getAll);
  app.get(`${apiRoutes.packages.base}/:id`, packageRoutes.getById);
  app.post(apiRoutes.packages.base, packageRoutes.create);
  app.put(`${apiRoutes.packages.base}/:id`, packageRoutes.update);
  app.delete(`${apiRoutes.packages.base}/:id`, packageRoutes.delete);

  // Payment routes
  app.get(apiRoutes.payments.base, paymentRoutes.getAll);
  app.get(`${apiRoutes.payments.base}/:id`, paymentRoutes.getById);
  app.get(`${apiRoutes.packages.base}/:packageId/payment`, paymentRoutes.getByPackageId);
  app.post(apiRoutes.payments.base, paymentRoutes.create);
  app.put(`${apiRoutes.payments.base}/:id`, paymentRoutes.update);
  app.delete(`${apiRoutes.payments.base}/:id`, paymentRoutes.delete);
}
